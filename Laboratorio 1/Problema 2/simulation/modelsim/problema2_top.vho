...
-- HEX1[0]	=>  Location: PIN_V17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- HEX1[1]	=>  Location: PIN_AE17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- HEX1[2]	=>  Location: PIN_AE18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- HEX1[3]	=>  Location: PIN_AD17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- HEX1[4]	=>  Location: PIN_AE16,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \U0|U1|Cout~0_combout\ = ( \SW[8]~input_o\ & ( \SW[0]~input_o\ & ( (\SW[1]~input_o\) # (\SW[5]~input_o\) ) ) ) # ( !\SW[8]~input_o\ & ( \SW[0]~input_o\ & ( (!\SW[5]~input_o\ & (\SW[1]~input_o\ & \SW[4]~input_o\)) # (\SW[5]~input_o\ & ((\SW[4]~input_o\) # 
-- (\SW[1]~input_o\))) ) ) ) # ( \SW[8]~input_o\ & ( !\SW[0]~input_o\ & ( (!\SW[5]~input_o\ & (\SW[1]~input_o\ & \SW[4]~input_o\)) # (\SW[5]~input_o\ & ((\SW[4]~input_o\) # (\SW[1]~input_o\))) ) ) ) # ( !\SW[8]~input_o\ & ( !\SW[0]~input_o\ & ( 
...
-- Equation(s):
-- \U0|U3|S~combout\ = ( \SW[7]~input_o\ & ( \SW[3]~input_o\ & ( (!\U0|U1|Cout~0_combout\ & (\SW[2]~input_o\ & \SW[6]~input_o\)) # (\U0|U1|Cout~0_combout\ & ((\SW[6]~input_o\) # (\SW[2]~input_o\))) ) ) ) # ( !\SW[7]~input_o\ & ( \SW[3]~input_o\ & ( 
-- (!\U0|U1|Cout~0_combout\ & ((!\SW[2]~input_o\) # (!\SW[6]~input_o\))) # (\U0|U1|Cout~0_combout\ & (!\SW[2]~input_o\ & !\SW[6]~input_o\)) ) ) ) # ( \SW[7]~input_o\ & ( !\SW[3]~input_o\ & ( (!\U0|U1|Cout~0_combout\ & ((!\SW[2]~input_o\) # 
-- (!\SW[6]~input_o\))) # (\U0|U1|Cout~0_combout\ & (!\SW[2]~input_o\ & !\SW[6]~input_o\)) ) ) ) # ( !\SW[7]~input_o\ & ( !\SW[3]~input_o\ & ( (!\U0|U1|Cout~0_combout\ & (\SW[2]~input_o\ & \SW[6]~input_o\)) # (\U0|U1|Cout~0_combout\ & ((\SW[6]~input_o\) # 
-- (\SW[2]~input_o\))) ) ) )
...
-- Equation(s):
-- \U0|U1|S~combout\ = ( \SW[8]~input_o\ & ( \SW[0]~input_o\ & ( !\SW[1]~input_o\ $ (\SW[5]~input_o\) ) ) ) # ( !\SW[8]~input_o\ & ( \SW[0]~input_o\ & ( !\SW[4]~input_o\ $ (!\SW[1]~input_o\ $ (\SW[5]~input_o\)) ) ) ) # ( \SW[8]~input_o\ & ( !\SW[0]~input_o\ 
-- & ( !\SW[4]~input_o\ $ (!\SW[1]~input_o\ $ (\SW[5]~input_o\)) ) ) ) # ( !\SW[8]~input_o\ & ( !\SW[0]~input_o\ & ( !\SW[1]~input_o\ $ (!\SW[5]~input_o\) ) ) )
...
-- Equation(s):
-- \U0|U0|S~combout\ = ( \SW[8]~input_o\ & ( \SW[0]~input_o\ & ( \SW[4]~input_o\ ) ) ) # ( !\SW[8]~input_o\ & ( \SW[0]~input_o\ & ( !\SW[4]~input_o\ ) ) ) # ( \SW[8]~input_o\ & ( !\SW[0]~input_o\ & ( !\SW[4]~input_o\ ) ) ) # ( !\SW[8]~input_o\ & ( 
...
-- Equation(s):
-- \Mux6~0_combout\ = ( \U0|U0|S~combout\ & ( (!\U0|U3|S~combout\ & (!\U0|U1|S~combout\ & !\U0|U2|S~combout\)) # (\U0|U3|S~combout\ & (!\U0|U1|S~combout\ $ (!\U0|U2|S~combout\))) ) ) # ( !\U0|U0|S~combout\ & ( (!\U0|U3|S~combout\ & (!\U0|U1|S~combout\ & 
-- \U0|U2|S~combout\)) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \U0|U3|ALT_INV_S~combout\,
	datab => \U0|U1|ALT_INV_S~combout\,
	datac => \U0|U2|ALT_INV_S~combout\,
...
-- Equation(s):
-- \Mux5~0_combout\ = ( \U0|U2|S~combout\ & ( \U0|U0|S~combout\ & ( !\U0|U3|S~combout\ $ (\U0|U1|S~combout\) ) ) ) # ( !\U0|U2|S~combout\ & ( \U0|U0|S~combout\ & ( (\U0|U3|S~combout\ & \U0|U1|S~combout\) ) ) ) # ( \U0|U2|S~combout\ & ( !\U0|U0|S~combout\ & ( 
-- (\U0|U1|S~combout\) # (\U0|U3|S~combout\) ) ) )
...
-- Equation(s):
-- \Mux4~0_combout\ = ( \U0|U0|S~combout\ & ( (\U0|U3|S~combout\ & (\U0|U1|S~combout\ & \U0|U2|S~combout\)) ) ) # ( !\U0|U0|S~combout\ & ( (!\U0|U3|S~combout\ & (\U0|U1|S~combout\ & !\U0|U2|S~combout\)) # (\U0|U3|S~combout\ & ((\U0|U2|S~combout\))) ) )
...
-- Equation(s):
-- \Mux3~0_combout\ = ( \U0|U0|S~combout\ & ( (!\U0|U1|S~combout\ & (!\U0|U3|S~combout\ & !\U0|U2|S~combout\)) # (\U0|U1|S~combout\ & ((\U0|U2|S~combout\))) ) ) # ( !\U0|U0|S~combout\ & ( (!\U0|U3|S~combout\ & (!\U0|U1|S~combout\ & \U0|U2|S~combout\)) # 
-- (\U0|U3|S~combout\ & (\U0|U1|S~combout\ & !\U0|U2|S~combout\)) ) )
...
-- Equation(s):
-- \Mux2~0_combout\ = ( \U0|U0|S~combout\ & ( (!\U0|U3|S~combout\) # ((!\U0|U1|S~combout\ & !\U0|U2|S~combout\)) ) ) # ( !\U0|U0|S~combout\ & ( (!\U0|U3|S~combout\ & (!\U0|U1|S~combout\ & \U0|U2|S~combout\)) ) )
...
-- Equation(s):
-- \Mux1~0_combout\ = ( \U0|U0|S~combout\ & ( !\U0|U3|S~combout\ $ (((!\U0|U1|S~combout\ & \U0|U2|S~combout\))) ) ) # ( !\U0|U0|S~combout\ & ( (\U0|U1|S~combout\ & (!\U0|U3|S~combout\ & !\U0|U2|S~combout\)) ) )
...
-- Equation(s):
-- \Mux0~0_combout\ = ( \U0|U0|S~combout\ & ( (!\U0|U1|S~combout\ $ (!\U0|U2|S~combout\)) # (\U0|U3|S~combout\) ) ) # ( !\U0|U0|S~combout\ & ( (!\U0|U3|S~combout\ $ (!\U0|U2|S~combout\)) # (\U0|U1|S~combout\) ) )
...
-- Equation(s):
-- \U0|U3|Cout~0_combout\ = ( \SW[7]~input_o\ & ( \SW[3]~input_o\ ) ) # ( !\SW[7]~input_o\ & ( \SW[3]~input_o\ & ( (!\SW[2]~input_o\ & (\SW[6]~input_o\ & \U0|U1|Cout~0_combout\)) # (\SW[2]~input_o\ & ((\U0|U1|Cout~0_combout\) # (\SW[6]~input_o\))) ) ) ) # ( 
-- \SW[7]~input_o\ & ( !\SW[3]~input_o\ & ( (!\SW[2]~input_o\ & (\SW[6]~input_o\ & \U0|U1|Cout~0_combout\)) # (\SW[2]~input_o\ & ((\U0|U1|Cout~0_combout\) # (\SW[6]~input_o\))) ) ) )
